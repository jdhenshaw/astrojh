...
PACKAGENAME = metadata.get('package_name', 'astrojh')
DESCRIPTION = metadata.get('description', 'Useful astronomy modules')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: astrojh requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
